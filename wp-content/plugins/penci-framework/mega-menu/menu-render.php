...
function penci_return_html_mega_menu( $row, $width,$dis_ajax_filter, $list_cats, $sub_cat ) {
	...
	$arr_has_mega    = array( 'category', 'post_tag', 'portfolio', 'product_cat', 'product_tag' );
	...
	<?php if ( ! empty( $list_cats ) && 1 == $sub_cat ): ?>
		<?php
		$class_child_cat = $col;
		$class_child_cat .= get_theme_mod( 'penci_mega_child_cat_style' ) ? ' penci-child_cat-' . get_theme_mod( 'penci_mega_child_cat_style' ) : ' penci-child_cat-style-1';
		?>
	...
	<?php endif; ?>
	<?php $content_megamenu_style = get_theme_mod( 'penci_mega_child_cat_style' ) ? ' penci-content-megamenu-' . get_theme_mod( 'penci_mega_child_cat_style' ) : ' penci-content-megamenu-style-1';  ?>
