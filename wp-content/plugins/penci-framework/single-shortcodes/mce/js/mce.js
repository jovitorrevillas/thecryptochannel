							...
							ed.windowManager.open( {
								...
								onsubmit: function ( e ) {
									...
									var $shortcode = '[penci_button  link="' + e.data.link + '" icon="' + e.data.icon + '" icon_position="' + e.data.icon_position + '"' +
									                 ...
									                 ( e.data.text_color ? ' text_hover_color="' + e.data.text_color + '"' : '' ) +
					...
					},
					{
						...
						onclick: function () {
							ed.windowManager.open( {
								...
								onsubmit: function ( e ) {
									content = ed.selection.getContent();
									ed.execCommand('mceInsertContent', 0, '[penci_related_posts taxonomies="' + e.data.taxonomies + '" title="' + e.data.title + '" background="' + e.data.background + '" border="' + e.data.border + '"  thumbright="' + e.data.thumbright + '" number="' + e.data.number + '" style="' + e.data.style + '" align="' + e.data.align + '" displayby="' + e.data.displayby + '" orderby="' + e.data.orderby + '"]' );
								}
							} );
						}
