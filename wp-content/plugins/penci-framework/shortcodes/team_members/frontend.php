			...
			foreach ( $team_members as $item ) {
				...
				<div class="penci-team_member_item <?php echo $class_col; ?>">
					<div class="penci-team_item__content">
						<div class="penci-team_member-img penci-lazy" style="background-image: url('<?php echo $url_img_item; ?>');"></div>
						<div class="penci-team_item__info">
							...
							<?php if ( $link_website_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_website_item ); ?>"><i class="fa fa-globe"></i></a>
							<?php endif; ?>
							<?php if ( $link_facebook_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_facebook_item ); ?>"><i class="fa fa-facebook"></i></a>
							<?php endif; ?>
							<?php if ( $link_google_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_google_item ); ?>"><i class="fa fa-google-plus"></i></a>
							<?php endif; ?>
							<?php if ( $link_twitter_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_twitter_item ); ?>"><i class="fa fa-twitter"></i></a>
							<?php endif; ?>
							<?php if ( $link_linkedin_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_linkedin_item ); ?>"><i class="fa fa-linkedin"></i></a>
							<?php endif; ?>
							<?php if ( $link_instagram_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_instagram_item ); ?>"><i class="fa fa-instagram"></i></a>
							<?php endif; ?>
							<?php if ( $link_youtube_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_youtube_item ); ?>"><i class="fa fa-youtube-play"></i></a>
							<?php endif; ?>
							<?php if ( $link_vimeo_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_vimeo_item ); ?>"><i class="fa fa-vimeo"></i></a>
							<?php endif; ?>
							<?php if ( $link_pinterest_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_pinterest_item ); ?>"><i class="fa fa-pinterest"></i></a>
							<?php endif; ?>
							<?php if ( $link_dribbble_item ): ?>
								<a <?php $link_target ?> class="penci-team_member_social" href="<?php echo esc_url( $link_dribbble_item ); ?>"><i class="fa fa-dribbble"></i></a>
							<?php endif; ?>
						</div>
						</div>
					</div>
