...
while ( $query_slider->have_posts() ) {
	...
	if ( $block9_i == 1 && ( ! isset( $styleAction ) || (  isset( $styleAction ) && 'load_more' != $styleAction ) ) ) {
		...
		$block9_first_item .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
		...
		$block9_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
