...
while ( $query_slider->have_posts() ) {
	...
	if ( ( $block34_i == 1 || $block34_i == 2 ) && ( ! isset( $styleAction ) || (  isset( $styleAction ) && 'load_more' != $styleAction ) )  ) {
		...
		$block34_big_item .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
		...
		$block34_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
