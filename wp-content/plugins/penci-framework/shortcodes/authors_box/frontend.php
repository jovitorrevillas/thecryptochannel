...
?>
	<div id="<?php echo esc_attr( $unique_id ); ?>" class="penci-block-vc penci-authors-box <?php echo esc_attr( implode( $class, ' ' ) ); ?>">
			...
			if ( ! empty( $authors ) ) {
				...
				foreach ( $authors as $author ) {
					...
					if ( ! $atts['hide_contact_info'] ):
						...
						if ( $user_url ) {
							$output .= '<a target="_blank" class="author-social" href="' . $user_url . '"><i class="fa fa-globe"></i></a>';
						}

						if ( $facebook ) {
							$output .= '<a target="_blank" class="author-social" href="http://facebook.com/' . $facebook . '"><i class="fa fa-facebook"></i></a>';
						}

						if ( $twitter ) {
							$output .= '<a target="_blank" class="author-social" href="http://twitter.com/' . $twitter . '"><i class="fa fa-twitter"></i></a>';
						}

						if ( $googleplus ) {
							$output .= '<a target="_blank" class="author-social" href="http://plus.google.com/' . $googleplus . '?rel=author"><i class="fa fa-google-plus"></i></a>';
						}

						if ( $instagram ) {
							$output .= '<a target="_blank" class="author-social" href="http://instagram.com/' . $instagram . '"><i class="fa fa-instagram"></i></a>';
						}

						if ( $pinterest ) {
							$output .= '<a target="_blank" class="author-social" href="http://pinterest.com/' . $pinterest . '"><i class="fa fa-pinterest"></i></a>';
						}

						if ( $tumblr ) {
							$output .= '<a target="_blank" class="author-social" href="http://' . $tumblr . '.tumblr.com/"><i class="fa fa-tumblr"></i></a>';
						}
