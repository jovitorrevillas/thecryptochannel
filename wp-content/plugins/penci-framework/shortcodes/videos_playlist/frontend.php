...
?>
	<div id="<?php echo esc_attr( $unique_id ); ?>" class="penci-block-vc penci-videos-playlist <?php echo esc_attr( implode( $class, ' ' ) ); ?>">
		...
		<div class="penci-block_content">
			<?php if ( ! empty( $videos_list ) ): ?>
				...
				<div class="penci-video-nav">
					...
					?>
					<div class="penci-video-playlist-nav<?php echo esc_attr( $class_nav ); ?>">
						<?php
						$video_number = 0;
						foreach ( $videos_list as $video ):
							...
							<span class="penci_media_object">
								<span class="penci_mobj__img">
									...
									printf( '<span class="penci-image-holder penci-video-thumbnail penci-lazy" data-src="%s" href="%s"><span class="screen-reader-text">%s</span></span>',
...
if ( 'style-video_list' == $atts['style_block_title'] ) {
	...
	if ( $atts['title_color'] ) {
		$css_custom .= sprintf( '%s .penci-video-nav .penci-playlist-title{ color:%s; }', $id_block_video, $atts['title_color'] );
	}
