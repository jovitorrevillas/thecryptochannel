...
if( 1 == $column_number ) {
	...
	while ( $query_slider->have_posts() ) {
		...
		if ( $block4_i == 1 && ( ! isset( $styleAction ) || (  isset( $styleAction ) && 'load_more' != $styleAction ) ) ) {
			...
			$block4_first_item .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
			...
			$block4_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date','comment' ), $atts );
