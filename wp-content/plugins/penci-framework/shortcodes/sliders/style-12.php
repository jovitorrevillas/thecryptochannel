				...
				<?php if ( ! $atts['hide_count_view'] || ! $atts['hide_comment'] ): ?>
					<div class="penci-slider__meta">
						...
						<?php if ( ! $atts['hide_comment'] ): ?>
							<span class="entry-meta-item penci-slider__comments"><a href="<?php comments_link(); ?> "><i class="la la-comments"></i><?php comments_number( esc_html__( '0 comment', 'snorlax' ), esc_html__( '1 comments', 'snorlax' ), '% ' . esc_html__( 'comments', 'snorlax' ) ); ?></a></span>
						<?php endif; ?>
