...
foreach ( $images as $i => $image ) {
	...
	$items .= sprintf( '<a class="penci-image-holder penci-lazy" data-src="%s" href="%s" title="%s"></a>',
		$src_thmb_960, $src_large, $caption_img );
	...
	$small_thumb .= sprintf( '<a class="penci-image-holder penci-lazy" data-src="%s" href="%s" title="%s"></a>',
		$src_thmb_280, $src_large, $caption_img );
	$small_thumb .= '</div>';
}
