...
while ( $query_slider->have_posts() ) {
	...
	if ( $block29_i < 4 ) {
		...
		$block21_first_items .= $block29_i == 1 ? Penci_Helper_Shortcode::get_post_meta( array( 'date', 'comment' ), $atts ) : '';
		...
		$block21_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date', 'comment' ), $atts );
