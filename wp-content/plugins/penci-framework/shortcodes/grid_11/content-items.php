...
while ( $query_slider->have_posts() ) {
	...
	if ( $grid11_i == 1 ) {
		...
		$grid11_first_item .= Penci_Helper_Shortcode::get_post_meta( array( 'author', 'date', 'comment' ), $atts );
		...
		$grid11_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date', 'comment' ), $atts );
