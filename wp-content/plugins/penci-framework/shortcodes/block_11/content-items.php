...
if( 1 == $column_number ) {
	...
	while ( $query_slider->have_posts() ) {
		...
		if ( $block11_i == 1 && ( ! isset( $styleAction ) || ( isset( $styleAction ) && 'load_more' != $styleAction ) ) ) {
			...
			$block11_first_item .= Penci_Helper_Shortcode::get_post_meta( array( 'date', 'comment', 'review' ), $atts );
			...
			$block11_items .= Penci_Helper_Shortcode::get_post_meta( array( 'date', 'comment' ), $atts );
