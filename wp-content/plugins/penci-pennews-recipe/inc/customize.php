 ...
 * @since 1.0
 */
if ( ! function_exists( 'penci_pennews_soledad_recipe_customizer' ) ) {
	function penci_pennews_soledad_recipe_customizer( $wp_customize ) {
		// Add Sections
...
add_action( 'customize_register', 'penci_pennews_soledad_recipe_customizer' );
