	...
	tinymce.PluginManager.add('tcbd_popover_mce_button', function( editor, url ) {
		editor.addButton( 'tcbd_popover_mce_button', {
			...
			menu: [
				...
				{
				text: 'TCBD Popover Image',
				onclick: function() {
					editor.windowManager.open( {
						title: 'TCBD Popover Image',
						body: [
							{
								type: 'textbox',
								name: 'imageurlBox',
						...
						onsubmit: function( e ) {
							editor.insertContent( '[tcbd-popover-image title="' + e.data.popovertitleBox + '" text="' + e.data.popovercontentBox + '" place="' + e.data.placmentbox + '" image_url="' + e.data.imageurlBox + '"][/tcbd-popover-image]');
						}
					});
				}
				},
				{
				text: 'TCBD Popover Image Link',
				onclick: function() {
					editor.windowManager.open( {
						title: 'TCBD Popover Image Link',
						body: [
							{
								type: 'textbox',
								name: 'imageurlBox',
						...
						onsubmit: function( e ) {
							editor.insertContent( '[tcbd-popover-image-link title="' + e.data.popovertitleBox + '" url="' + e.data.urlBox + '" text="' + e.data.popovercontentBox + '" place="' + e.data.placmentbox + '" image_url="' + e.data.imageurlBox + '"][/tcbd-popover-image-link]');
						}
					});
				}
				}				
