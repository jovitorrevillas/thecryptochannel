...
function tcbd_popover_text( $atts, $content = null  ) {
	...
	return '<span data-container="body" data-toggle="popover" title="'.$title.'" data-placement="'.$place.'" data-content="'.$text.'" data-html="true">'.$content.'</span>';
}	
...
function tcbd_popover_link( $atts, $content = null  ) {
	...
	return '<a href="'.esc_url($url).'" data-container="body" data-toggle="popover" title="'.$title.'" data-placement="'.$place.'" data-content="'.$text.'" data-html="true">'.$content.'</a>';
}	
add_shortcode('tcbd-popover-link', 'tcbd_popover_link');

// TCBD Popover Image Shortcode
function tcbd_popover_image( $atts, $content = null  ) {
	extract( shortcode_atts( array(
		'title' => '',
		'place' => 'top',
		'text' => '',
	...
	return '<span class="tcbd-image" data-container="body" data-toggle="popover" title="'.$title.'" data-placement="'.$place.'" data-content="'.$text.'" data-html="true"><img src="'.$image_url.'" alt="" /></span>';
}	
add_shortcode('tcbd-popover-image', 'tcbd_popover_image');

// TCBD Popover Image-Link Shortcode
function tcbd_popover_image_link( $atts, $content = null  ) {
	extract( shortcode_atts( array(
		'title' => '',
		'place' => 'top',
		'text' => '',
	...
	return '<a class="tcbd-image" href="'.esc_url($url).'" data-container="body" data-toggle="popover" title="'.$title.'" data-placement="'.$place.'" data-content="'.$text.'" data-html="true"><img src="'.$image_url.'" alt="" /></a>';
}	
add_shortcode('tcbd-popover-image-link', 'tcbd_popover_image_link');
