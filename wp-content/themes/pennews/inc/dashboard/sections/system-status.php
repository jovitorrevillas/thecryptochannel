                        ...
                        <td class="system-status-status">
                            <?php
                                switch ($status_params['status']) {
                                    case 'green':
                                        echo '<div class="system-status-green penci-tooltip" data-position="right" title="' . ( $status_params['tooltip'] ) . '"></div>';
                                        break;
                                    case 'yellow':
                                        echo '<div class="system-status-yellow penci-tooltip" data-position="right" title="' . ( $status_params['tooltip'] ) . '"></div>';
                                        break;
                                    case 'red' :
                                        echo '<div class="system-status-red penci-tooltip" data-position="right" title="' . ( $status_params['tooltip'] ) . '"></div>';
                                        break;
                                    case 'info':
                                        echo '<div class="system-status-info penci-tooltip" data-position="right" title="' . ( $status_params['tooltip'] ) . '">i</div>';
                                        break;
                                }
                            ?>
                        </td>
