...
If your site has old data, please do only <strong>Way 2: Import Only customizer data</strong> like the guide <a href="http://pennews.pencidesign.com/pennews-document/#import-demo" target="_blank">here</a>. If not, click to button bellow to import full a demo.', 'pennews' );
	...
	<div class="feature-section products three-col">
		<div class="col product">
			<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/soledad-multiconcept-blogmagazine-wp-theme/12945398?ref=PenciDesign" ) ?>" title="<?php echo esc_attr( 'Soledad' ) ?>">
			...
			<div class="product__body">
				<h3 class="product__title">
					<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/soledad-multiconcept-blogmagazine-wp-theme/12945398?ref=PenciDesign/" ) ?>" title="<?php echo esc_attr( 'Soledad' ) ?>">Soledad - Multi-Concept Blog/Magazine AMP WordPress Theme</a>
				</h3>
			</div>
		</div>
		<div class="col product">
			<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/penshop-multipurpose-ecommerce-wordpress-theme/20469533?ref=PenciDesign" ) ?>" title="<?php echo esc_attr( 'PenShop' ) ?>">
			...
			<div class="product__body">
				<h3 class="product__title">
					<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/penshop-multipurpose-ecommerce-wordpress-theme/20469533?ref=PenciDesign" ) ?>" title="<?php echo esc_attr( 'PenShop - Multi-Purpose eCommerce WordPress Theme' ) ?>">PenShop - Multi-Purpose eCommerce WordPress Theme</a>
				</h3>
			</div>
		</div>
		<div class="col product">
			<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/vancouver-multiple-layouts-wordpress-blog-theme/12180181?ref=PenciDesign" ) ?>" title="<?php echo esc_attr( 'Vancouver' ) ?>">
			...
			<div class="product__body">
				<h3 class="product__title">
					<a target="_blank" href="<?php echo esc_url( "https://themeforest.net/item/vancouver-multiple-layouts-wordpress-blog-theme/12180181?ref=PenciDesign" ) ?>" title="<?php echo esc_attr( 'Vancouver' ) ?>">Vancouver - Multiple Layouts WordPress Blog Theme</a>
				</h3>
			</div>
		</div>
