...
class Penci_Post_Gallery {
	...
	public function custom_markup_for_gallery( $string, $attr ) {
		...
		if ( $type == 'single-slider' ):
			...
			$output .= '<div class="penci-owl-carousel-slider" data-items="1" data-autowidth="0" data-auto="1" data-autotime="4000" data-speed="600" data-loop="0" data-dots="0" data-nav="1" data-magrin="0" data-center="0">';
		endif;
