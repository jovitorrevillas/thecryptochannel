...
function penci_customizer_footer_signup() {
	...
	$signup_padding_top       = get_theme_mod( 'penci_footer_signup_ptop' );
	$signup_padding_bottom    = get_theme_mod( 'penci_footer_signup_pbottom' );
	$footer_signup_mar_bottom = get_theme_mod( 'penci_footer_signup_mar_bottom' );
	...
	$signup_bg            = get_theme_mod( 'penci_footer_signup_bg' );
	$signup_color         = get_theme_mod( 'penci_footer_signup_color' );
	$signup_heading_color = get_theme_mod( 'penci_footer_signup_heading_color' );
	$signup_input_border  = get_theme_mod( 'penci_footer_signup_input_border' );
	$signup_input_color   = get_theme_mod( 'penci_footer_signup_input_color' );
	$signup_iplace_color  = get_theme_mod( 'penci_footer_signup_iplace_color' );
	$signup_submit_bg     = get_theme_mod( 'penci_footer_signup_submit_bg' );
	$signup_submit_color  = get_theme_mod( 'penci_footer_signup_submit_color' );
	$signup_submit_hbg    = get_theme_mod( 'penci_footer_signup_submit_hbg' );
	$signup_submit_hcolor = get_theme_mod( 'penci_footer_signup_submit_hcolor' );
