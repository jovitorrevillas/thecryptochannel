...
function penci_customizer_portfolio() {
	...
	$title_color     = get_theme_mod( 'penci_portfolio_title_color' );
	$title_hcolor    = get_theme_mod( 'penci_portfolio_title_hcolor' );
	$cate_color      = get_theme_mod( 'penci_portfolio_cate_color' );
	$cate_hcolor     = get_theme_mod( 'penci_portfolio_cate_hcolor' );
	$overlay_color   = get_theme_mod( 'penci_portfolio_overlay_color' );
	$overlay_opacity = get_theme_mod( 'penci_portfolio_overlay_opacity' );
	$space_item      = get_theme_mod( 'penci_pfl_spacing_item' );
	...
	// Button load more
	$loadmore_color    = get_theme_mod( 'penci_pft_loadmore_color' );
	$loadmore_bcolor   = get_theme_mod( 'penci_pft_loadmore_bcolor' );
	$loadmore_bgcolor  = get_theme_mod( 'penci_pft_loadmore_bgcolor' );
	$loadmore_hcolor   = get_theme_mod( 'penci_pft_loadmore_hcolor' );
	$loadmore_hbcolor  = get_theme_mod( 'penci_pft_loadmore_hbcolor' );
	$loadmore_hbgcolor = get_theme_mod( 'penci_pft_loadmore_hbgcolor' );
	$loadmore_border_size = get_theme_mod( 'penci_pft_loadmore_bordsize' );
	$loadmore_animation_color = get_theme_mod( 'penci_pft_loadmore_animation_color' );
	$readmore_margin_top = get_theme_mod( 'penci_pfl_readmore_margin_top' );
	...
	$item_title_size = get_theme_mod( 'penci_portfolio_item_title_size' );
	$item_cat_size = get_theme_mod( 'penci_portfolio_item_cat_size' );
