...
function penci_customizer_topbar() {
	...
	// Extra
	$topbar_font_size   = get_theme_mod( 'penci_topbar_font_size' );
	$trending_text_fsize  = get_theme_mod( 'penci_topbar_trending_text_fsize' );
	$trending_ptitle_fsize  = get_theme_mod( 'penci_topbar_trending_ptitle_fsize' );
	$penci_topbar_socials_fsize  = get_theme_mod( 'penci_topbar_socials_fsize' );
	...
	$turn_off_upearcase = get_theme_mod( 'penci_topbar_turn_off_upearcase' );
	$trending_width     = get_theme_mod( 'penci_topbar_trending_width' );
	$trending_speed     = get_theme_mod( 'penci_topbar_trending_speed' );
	$bgcolor            = get_theme_mod( 'penci_topbar_bgcolor' );
	$color              = get_theme_mod( 'penci_topbar_color' );
	$hover_color        = get_theme_mod( 'penci_topbar_hover_color' );
	$icon_color         = get_theme_mod( 'penci_topbar_icon_color' );
	$icon_hcolor        = get_theme_mod( 'penci_topbar_icon_hcolor' );
	$tren_bgcolor       = get_theme_mod( 'penci_topbar_tren_bgcolor' );
	$tren_color         = get_theme_mod( 'penci_topbar_tren_color' );
	$submenu_bgcolor    = get_theme_mod( 'penci_topbar_submenu_bgcolor' );
	$submenu_color      = get_theme_mod( 'penci_topbar_submenu_color' );
	$submenu_hcolor     = get_theme_mod( 'penci_topbar_submenu_hcolor' );
	$border_items       = get_theme_mod( 'penci_topbar_border_items' );
