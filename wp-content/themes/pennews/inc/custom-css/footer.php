...
function penci_customizer_footer() {
	...
	// Logo
	$font_textlogo        = get_theme_mod( 'penci_footer_font_textlogo' );
	$font_weight_textlogo = get_theme_mod( 'penci_footer_fweight_textlogo' );
	$fontsize_textlogo    = get_theme_mod( 'penci_footer_fsize_textlogo' );
	...
	$footer_wptop    = get_theme_mod( 'penci_footer_w_padding_top' );
	$footer_wpbottom = get_theme_mod( 'penci_footer_w_padding_bottom' );
	$footer_wpadding = '';
	...
	// Widget
	$font_blocktitle                = get_theme_mod( 'penci_fwidget_font_blocktitle' );
	$font_weight_blocktitle         = get_theme_mod( 'penci_fwidget_weight_blocktitle' );
	$font_size_blocktitle           = get_theme_mod( 'penci_fwidget_fontsize_blocktitle' );
	$border_bottom_width_blocktitle = get_theme_mod( 'penci_fwidget_lineheight_blocktitle' );
	$dis_upper_blocktitle           = get_theme_mod( 'penci_fwidget_upper_blocktitle' );
	$dis_border_blocktitle          = get_theme_mod( 'penci_fwidget_border_blocktitle' );
	$dis_fwidth_border_bottom       = get_theme_mod( 'penci_fwidget_border_bottom' );
	...
	$footer_bottom_padding_top    = get_theme_mod( 'penci_footer_bottom_padding_top' );
	$footer_bottom_padding_bottom = get_theme_mod( 'penci_footer_bottom_padding_bottom' );
	...
	$fsize_title_cr  = get_theme_mod( 'penci_footer_fsize_title_cr' );
	$fsize_copyright = get_theme_mod( 'penci_footer_fsize_copyright' );
	if ( $fsize_title_cr ) {
	...
	// Logo
	$bottom_padding_logo        = get_theme_mod( 'penci_footer_bottom_padding_logo' );
	$penci_footer_maxwidth_logo = get_theme_mod( 'penci_footer_maxwidth_logo' );
	$fontsize_social            = get_theme_mod( 'penci_footer_fontsize_social' );
	$wh_social                  = get_theme_mod( 'penci_footer_wh_social' );
