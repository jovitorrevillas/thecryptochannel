...
function penci_customizer_sidebar() {
	...
	$widget_margin_bottom =  get_theme_mod( 'penci_sidebar_widget_margin_bottom' );
	...
	$fontfamily_blocktitle   = get_theme_mod( 'penci_font_blocktitle' );
	$font_weight_blocktitle  = get_theme_mod( 'penci_font_weight_blocktitle' );
	$font_size_blocktitle    = get_theme_mod( 'penci_font_for_size_blocktitle' );
	$hline_bottom_blocktitle = intval( get_theme_mod( 'penci_height_line_bottom_blocktitle' ) );
	$hline_top_blocktitle    = get_theme_mod( 'penci_height_line_top_blocktitle' );

	$hline_blocktitle_11_12 = intval( get_theme_mod( 'penci_height_line_blocktitle11_12' ) );
	...
	if ( $font_blocktitle ) {
		$css .= sprintf( '.post-title-box .post-box-title,.site-content #respond h3,.site-content .widget-title,
		.site-content .widgettitle,.site-content .widget.penci-block-vc .penci-block__title{ %s }', ( $font_blocktitle ) );
	}
	...
	if( get_theme_mod( 'penci_off_uppearcase_block_title' ) ) {
