...
function penci_customizer_mobile_nav() {
	...
	// Text logo
	if ( ! get_theme_mod( 'hide_mobile_nav_logo' ) ) {
		$font_textlogo_on_mobile = get_theme_mod( 'penci_font_textlogo_mobile_nav' );
		...
		if ( get_theme_mod( 'penci_fweight_textlogo_mobile_nav' ) ) {
			$css_nav_logo .= 'font-weight: ' . esc_attr( get_theme_mod( 'penci_fweight_textlogo_mobile_nav' ) ) . ';';
		}

		if ( get_theme_mod( 'penci_fsize_textlogo_mobile_nav' ) ) {
			$css_nav_logo .= 'font-size: ' . get_theme_mod( 'penci_fsize_textlogo_mobile_nav' ) . 'px;';
		}
	...
	$penci_mobile_bg           = get_theme_mod( 'penci_mobile_bg' );
	$mobile_overlay_color      = get_theme_mod( 'mobile_overlay_color' );
	$mobile_close_bg           = get_theme_mod( 'mobile_close_bg' );
	$mobile_close_color        = get_theme_mod( 'mobile_close_color' );
	$mobile_nav_bg             = get_theme_mod( 'mobile_nav_bg' );
	$mobile_accent_color       = get_theme_mod( 'mobile_accent_color' );
	$mobile_accent_hover_color = get_theme_mod( 'mobile_accent_hover_color' );
	$mobile_items_border       = get_theme_mod( 'mobile_items_border' );
	...
	$nav_menu_font_size =  get_theme_mod( 'penci_mobile_nav_menu_font_size' );
	if( $nav_menu_font_size ) {
		$css .= sprintf( '.mobile-sidebar .primary-menu-mobile li a{ font-size:%spx ; }', esc_attr( $nav_menu_font_size ) );
	}

	$textlogo_fsize =  get_theme_mod( 'penci_mobile_nav_textlogo_fsize' );
	if( $textlogo_fsize ) {
