...
function penci_customizer_color_footer() {
	...
	$footer_bg_img     = get_theme_mod( 'penci_footer_background_img' );
	$footer_bg         = get_theme_mod( 'penci_footer_bg' );
	$footer_border_top = get_theme_mod( 'penci_footer_border_top' );
	...
	// Footer bottom
	$footer_bottom_bg             = get_theme_mod( 'penci_footer_bottom_bg' );
	$footer_bottom_text_color     = get_theme_mod( 'penci_footer_bottom_text_color' );
	$footer_bottom_title_cr_color = get_theme_mod( 'penci_footer_bottom_title_cr_color' );
	$footer_bottom_link_color     = get_theme_mod( 'penci_footer_bottom_link_color' );
	$footer_bottom_link_hcolor    = get_theme_mod( 'penci_footer_bottom_link_hcolor' );
	...
	/********** Widget ************/
	$widget_area_bg            = get_theme_mod( 'penci_footer_widget_area_bg' );
	$widget_area_border_bottom = get_theme_mod( 'penci_footer_widget_area_border_bottom' );
	$widget_color              = get_theme_mod( 'penci_footer_widget_color' );
	$widget_accent_color       = get_theme_mod( 'penci_footer_widget_accent_color' );
	$widget_accent_hover_color = get_theme_mod( 'penci_footer_widget_accent_hover_color' );
	$widget_list_border_color  = get_theme_mod( 'penci_footer_widget_list_border_color' );

	$widget_title_border_color = get_theme_mod( 'penci_footer_widget_title_border_color' );
	$widget_area_title_color   = get_theme_mod( 'penci_footer_widget_area_title_color' );
	$widget_title_bg_color     = get_theme_mod( 'penci_footer_widget_title_bg_color' );
	...
	if ( $widget_list_border_color ) {
		...
		$css .= '.footer__sidebars #wp-calendar tbody td,';
	...
	/********** Social icon ************/
	$penci_footer_icon_color          = get_theme_mod( 'penci_footer_icon_color' );
	$penci_footer_icon_bg_color       = get_theme_mod( 'penci_footer_icon_bg_color' );
	$penci_footer_icon_hover_color    = get_theme_mod( 'penci_footer_icon_hover_color' );
	$penci_footer_icon_bg_hover_color = get_theme_mod( 'penci_footer_icon_bg_hover_color' );
	...
	/********** Logo ************/
	$penci_footer_logo_color = get_theme_mod( 'penci_footer_logo_color' );
	if ( $penci_footer_logo_color ) {
		$css .= sprintf( '.footer__logo a,.footer__logo a:hover{ color:%s ; }', esc_attr( $penci_footer_logo_color ) );
	}

	/********** Copyright ************/
	$penci_footer_copyright_bg_color   = get_theme_mod( 'penci_footer_copyright_bg_color' );
	$penci_footer_copyright_text_color = get_theme_mod( 'penci_footer_copyright_text_color' );
	$penci_footer_copyright_link_color = get_theme_mod( 'penci_footer_copyright_link_color' );
	...
	/********** Menu link ************/
	$footer_menu_color  = get_theme_mod( 'penci_footer_menu_link_color' );
	$footer_menu_hcolor = get_theme_mod( 'penci_footer_menu_link_hcolor' );
	...
	/********** Go to top ************/
	$penci_gototop_color         = get_theme_mod( 'penci_gototop_color' );
	$penci_gototop_bgcolor       = get_theme_mod( 'penci_gototop_bgcolor' );
	$penci_gototop_hover_color   = get_theme_mod( 'penci_gototop_hover_color' );
	$penci_gototop_hover_bgcolor = get_theme_mod( 'penci_gototop_hover_bgcolor' );
