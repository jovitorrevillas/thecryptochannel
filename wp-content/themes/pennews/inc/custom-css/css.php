...
class Pemag_Customizer_CSS {
	...
	public function add_custom_fonts(){
		$font_1      = get_option( 'pennews_custom_font1' );
		$fontfamily1 = get_option( 'pennews_custom_fontfamily1' );
		$font_2       = get_option( 'pennews_custom_font2' );
		$fontfamily2 = get_option( 'pennews_custom_fontfamily2' );
		$font_3       = get_option( 'pennews_custom_font3' );
		$fontfamily3 = get_option( 'pennews_custom_fontfamily3' );

		$font_4       = get_option( 'pennews_custom_font4' );
		$fontfamily4 = get_option( 'pennews_custom_fontfamily4' );

		$font_5       = get_option( 'pennews_custom_font5' );
		$fontfamily5 = get_option( 'pennews_custom_fontfamily5' );

		$font_6       = get_option( 'pennews_custom_font6' );
		$fontfamily6 = get_option( 'pennews_custom_fontfamily6' );

		$font_7       = get_option( 'pennews_custom_font7' );
		$fontfamily7 = get_option( 'pennews_custom_fontfamily7' );

		$font_8       = get_option( 'pennews_custom_font8' );
		$fontfamily8 = get_option( 'pennews_custom_fontfamily8' );

		$font_9       = get_option( 'pennews_custom_font9' );
		$fontfamily9 = get_option( 'pennews_custom_fontfamily9' );

		$font_10       = get_option( 'pennews_custom_font10' );
		$fontfamily10 = get_option( 'pennews_custom_fontfamily10' );
