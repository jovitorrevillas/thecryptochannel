...
function penci_customizer_sign_up_form() {
	...
	$penci_login_bg_img          = get_theme_mod( 'penci_login_bg_img' );
	$penci_login_bg_repeat       = get_theme_mod( 'penci_login_bg_repeat' );
	$penci_login_bg_pos          = get_theme_mod( 'penci_login_bg_pos' );
	$penci_login_bg_size         = get_theme_mod( 'penci_login_bg_size' );
	$lregister_bg_color          = get_theme_mod( 'penci_login_register_bg_color' );
	$lregister_title_color       = get_theme_mod( 'penci_login_register_title_color' );
	$lregister_text_color        = get_theme_mod( 'penci_login_register_text_color' );
	$lregister_input_color       = get_theme_mod( 'penci_login_register_input_color' );
	$lregister_input_placeholder = get_theme_mod( 'penci_login_register_input_placeholder' );
	$lregister_input_brcolor     = get_theme_mod( 'penci_login_register_input_brcolor' );
	$lregister_link_color        = get_theme_mod( 'penci_login_register_link_color' );
	$lregister_link_hcolor       = get_theme_mod( 'penci_login_register_link_hcolor' );
	$lregister_button_color      = get_theme_mod( 'penci_login_register_button_color' );
	$lregister_button_bgcolor    = get_theme_mod( 'penci_login_register_button_bgcolor' );
	$lregister_button_hcolor     = get_theme_mod( 'penci_login_register_button_hcolor' );
	$lregister_button_hbgcolor   = get_theme_mod( 'penci_login_register_button_hbgcolor' );
	...
	if ( $lregister_title_color ) {
		$css .= sprintf( '.penci-popup-login-register h2{ color:%s ; }', $lregister_title_color );
	}
