...
function penci_register_required_plugins() {
	$plugins = array(
		...
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/penci-framework.zip',
			'required' => true,
			'version'  => '1.1',
		),
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/vafpress-post-formats-ui-develop.zip',
			'required' => false,
		),
		array(
			'name'     => esc_html__( 'Penci PenNews Slider', 'pennews' ),
			'slug'     => 'penci-pennew-slider',
			'source'   => get_template_directory_uri() . '/plugins/penci-pennew-slider.zip',
			'required' => false,
			'version'  => '1.1',
		),
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/penci-pennews-portfolio.zip',
			'required' => false,
			'version'  => '1.2',
		),
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/penci-pennews-review.zip',
			'required' => false,
			'version'  => '1.1',
		),
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/penci-pennews-recipe.zip',
			'required' => false,
			'version'  => '1.2',
		),
		array(
			...
			'source'   => get_template_directory_uri() . '/plugins/penci-pennews-demo-importer.zip',
			'required' => false,
			'version'  => '1.1',
		),array(
			'name'     => esc_html__( 'Penci PenNews Migrator', 'pennews' ),
			'slug'     => 'penci-pennews-migrator',
			'source'   => get_template_directory_uri() . '/plugins/penci-pennews-migrator.zip',
			'required' => false,
			'version'  => '1.0.0',
		),
		array(
