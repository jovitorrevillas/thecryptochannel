...
$wp_customize->add_control( new Penci_Customize_Control_Radio_Image(
	...
	array(
		...
		'choices'  => array(
			'blog-default' => array( 'url' => '%s/images/layout/thumb-text.png', 'label' => esc_html__( 'Default', 'pennews' ) ),
			'blog-grid'    => array( 'url' => '%s/images/layout/2-columns.png', 'label' => esc_html__( 'Grid', 'pennews' ) ),
			'blog-boxed'    => array( 'url' => '%s/images/layout/thumb-text-2.png', 'label' => esc_html__( 'Style 3', 'pennews' ) ),
...
$wp_customize->add_setting( 'penci_hide_archive_title', array(
	'sanitize_callback' => array( $sanitizer, 'checkbox' ),
) );

$wp_customize->add_control( new WP_Customize_Control(
	$wp_customize,
	'penci_hide_archive_title',
	array(
		'label'    => esc_html__( 'Hide Archive Title', 'pennews' ),
		'section'  => 'penci_archive',
		'type'     => 'checkbox',
		'settings' => 'penci_hide_archive_title',
	)
) );
