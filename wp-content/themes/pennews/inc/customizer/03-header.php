...
$wp_customize->add_control( new Penci_Customize_Font_Size_Control( $wp_customize, 'penci_logo_width', array(
	'label'    => esc_html__( 'Logo Width For Header 1,2,8,9,10,11 ( maximum 400px )', 'pennews' ),
	'section'  => 'penci_panel_header',
...
$header_list_check = array(
	...
	'penci_hide_post_date_mega_menu'       => esc_html( 'Hide Post Date Of Mega Menu', 'pennews' ),
...
$wp_customize->add_setting( 'custom_code_inside_head_tag', array(
	'sanitize_callback' => array( $sanitizer, 'html' )
) );
