<div class="penci-header-mobile<?php echo esc_attr( wp_is_mobile() ? ' mobile' : '' ); ?>" >
	<div class="penci-header-mobile_container">
		...
		<?php if ( penci_get_setting( 'penci_use_textlogo' ) && penci_get_setting( 'penci_text_logo_on_mobile' ) ) {
			?>
		<div class="site-branding"><div class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo penci_get_setting( 'penci_text_logo_on_mobile' ); ?></a></div></div>
			<?php
		} elseif ( penci_get_setting( 'penci_use_textlogo' ) && penci_get_setting( 'penci_text_logo' ) ) {
			?>
			<div class="site-branding"><div class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo penci_get_setting( 'penci_text_logo' ); ?></a></div></div>
			<?php
		} else {
			if ( penci_get_setting( 'penci_logo_header_mobile' ) ) : ?>
				<div class="site-branding"> <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="custom-logo-link logo_header_mobile"><img src="<?php echo esc_url( penci_get_setting( 'penci_logo_header_mobile' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>"/></a></div>
		...
		if ( ! $header_search ): ?>
			<div class="header__search<?php  echo ( $dis_search_bg ? ' header__search_dis_bg': '' ); ?>" id="top-search-mobile">
					...
					<div class="show-search__content">
						<form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
							<label>
								...
								<input type="text" class="search-field" placeholder="<?php esc_attr_e( 'Enter keyword...', 'pennews' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" autocomplete="<?php echo esc_attr( $autocomplete ); ?>">
							</label>
