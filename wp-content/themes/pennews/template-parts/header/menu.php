...
$class_menu .= get_theme_mod( 'penci_dropdown_menu_style' ) ? ' pencimn-' . get_theme_mod( 'penci_dropdown_menu_style' ) : ' pencimn-slide_down';
?>
<nav id="site-navigation" class="main-navigation<?php echo esc_attr( $class_menu ); ?>" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
	<?php
	wp_nav_menu( array(
		'container'      => '',
