<?php
$hide_footer_content = get_theme_mod( 'penci_hide_footer_content' );
...
$footer_hide_socials = get_theme_mod( 'penci_hide_footer_socails' );
$footer_text         = get_theme_mod( 'penci_footer_text' );
$footer_hide_logo    = get_theme_mod( 'penci_hide_footer_logo' );
$footer_logo         = get_theme_mod( 'penci_footer_logo' );
		...
		<div class="footer__bottom_container <?php penci_get_class_footer_width(); ?>">
			<?php if ( ! $footer_hide_logo ): ?>
				<div class="footer__logo">
					<?php
					if ( get_theme_mod( 'penci_footer_use_textlogo' ) && get_theme_mod( 'penci_footer_text_logo' ) ) {
						echo '<a href="' . esc_url( home_url( '/' ) ) . '" rel="home">';
						echo get_theme_mod( 'penci_footer_text_logo' );
						echo '</a>';
					} elseif ( $footer_logo ) {
						echo '<a href="' . esc_url( home_url( '/' ) ) . '" rel="home">';
