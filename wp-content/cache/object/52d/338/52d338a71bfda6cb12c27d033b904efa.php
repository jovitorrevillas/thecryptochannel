$1ÌZ<?php exit; ?>a:1:{s:7:"content";s:12133:"		<div id="su-generator-wrap" style="display:none">
			<div id="su-generator">
				<div id="su-generator-header">
					<div id="su-generator-tools"><a href="https://cryptochannel.frb.io/wp-admin/admin.php?page=shortcodes-ultimate#tab-1" target="_blank" title="Settings">Plugin settings</a> <span></span> <a href="http://gndev.info/shortcodes-ultimate/" target="_blank" title="Plugin homepage">Plugin homepage</a> <span></span> <a href="http://wordpress.org/support/plugin/shortcodes-ultimate/" target="_blank" title="Support forums">Support forums</a> <span></span> <a href="https://cryptochannel.frb.io/wp-admin/admin.php?page=shortcodes-ultimate-addons" target="_blank" title="Add-ons" class="su-add-ons">Add-ons</a></div>
...
<span data-name="Columns" data-shortcode="row" title="Row for flexible columns" data-desc="Row for flexible columns" data-group="box"><i class="fa fa-columns"></i>Columns</span>
...
<span data-name="Google map" data-shortcode="gmap" title="Maps by Google" data-desc="Maps by Google" data-group="media"><i class="fa fa-globe"></i>Google map</span>
...
<span data-name="Meta data" data-shortcode="meta" title="Post meta" data-desc="Post meta" data-group="data"><i class="fa fa-info-circle"></i>Meta data</span>
<span data-name="User data" data-shortcode="user" title="User data" data-desc="User data" data-group="data"><i class="fa fa-info-circle"></i>User data</span>
<span data-name="Post data" data-shortcode="post" title="Post data" data-desc="Post data" data-group="data"><i class="fa fa-info-circle"></i>Post data</span>
...
<span data-name="Scheduler" data-shortcode="scheduler" title="Allows to show the content only at the specified time period" data-desc="Allows to show the content only at the specified time period" data-group="other"><i class="fa fa-clock-o"></i>Scheduler</span>
				...
				<input type="hidden" name="su-generator-selected" id="su-generator-selected" value="https://cryptochannel.frb.io/wp-content/plugins/shortcodes-ultimate" />
				<input type="hidden" name="su-generator-url" id="su-generator-url" value="https://cryptochannel.frb.io/wp-content/plugins/shortcodes-ultimate" />
